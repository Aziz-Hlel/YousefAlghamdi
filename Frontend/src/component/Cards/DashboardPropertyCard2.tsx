...
function DashboardPropertyCard({ _id, status, image, why, title, location, }: IDashboardPropertyCard) {
  return (
    <div className="homec-dashboard-property mg-top-30">
      ...
      <div className="homec-dashboard-property__buttons ">
        ...
        <button className="homec-dashboard-property__btn homec-dashboard-property__btn--delete flex justify-center items-center">
          <svg
            width="16"
            height="21"
            viewBox="0 0 16 21"
