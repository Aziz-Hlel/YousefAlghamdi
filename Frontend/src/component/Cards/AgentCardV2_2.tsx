  ...
  return (
    <div className="group" >
      ...
      <div className="text-center">
        ...
        <a href={detailsLink} className=" w-full">
          <p className=" text-center">
            <div className=" group flex  justify-center items-center rounded-full  w-full h-fit p-1.5 bg-[#ECEAFF] hover:bg-[#7166F0] hover:cursor-pointer">
              ...
              <span className=" group-hover:text-white duration-300">{detailsLink}</span>
            </div>
          </p>
