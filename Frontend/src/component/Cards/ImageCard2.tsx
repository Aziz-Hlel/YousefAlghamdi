...
const Currency = () => {
  ...
  return (
    <svg
      ...
      className="md:h-12 md:w-6 h-6 w-4 fill-[#7166F0] "
    >
      <path
        id="Layer copy"
...
function ImageCard({ price, duration, title, text, img }: IimageCard) {
  return (
    <div className="homec-image-gallery">
      {/* Amount Card  */}
      <div className="homec-amount-card homec-amount-card__sticky gap-0 h-fit">
        <div className="homec-amount-card__amount">
          <div className="flex  items-center my-0  h-8 ">
            <Currency />
            {price}
