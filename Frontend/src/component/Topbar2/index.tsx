        ...
        <div className="row">
          <div className="col-12">
            ...
            >
              ...
              {/* Social  */}
              <ul
                className={`homec-social homec-social__topbar ${v2 && "homec-social__topbar--v2"} justify-center items-center flex`}
              >

                <li>
                  <a href={companySocials.tiktok} target="_blank" className="group" >
                    <svg
                      viewBox="0 0 24 24"
                      fill="none"
                    ...
                    >
                      <path
                        ...
                        className=" fill-none stroke-white group-hover:stroke-[#7065F0] duration-300"
                      />
                    </svg>
                  </a>
                </li>
                ...
                <li>
                  <a href={companySocials.snapchat} target="_blank" className="group" >
                    <svg
                      viewBox="0 0 48 48"
                      xmlns="http://www.w3.org/2000/svg"
                      fill="none"
                      width="24"
                      height="24"
                      className="homec-svg  hover:stroke-black hover:fill-black group-hover:fill-black group-hover:stroke-black"
                    ...
                    >
                      <path
                        ...
                        strokeLinecap="round"
                        strokeLinejoin="round"
                        className="homec-svg  group-hover:stroke-[#7065F0] duration-300"
                ...
                <li>
                  <a href={companySocials.instagram} className=" flex justify-center items-center w-full" target="_blank" >
                ...
                <li>
                  <a href={companySocials.twitter} className=" flex justify-center items-center w-full" target="_blank" >
                ...
                <li>
                  <a href={companySocials.linkedin} target="_blank" className="group" >
