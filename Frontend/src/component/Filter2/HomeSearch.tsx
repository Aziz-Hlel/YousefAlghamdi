...
const purpose = ['rent', 'buy', 'commercial'];
  ...
  return (
    ...
    >
      <div className="homec-search-form__form homec-search-form__form--city flex justify-center items-center">
        ...
        <div className="homec-search-form__group border-2 rounded-lg w-96 ">
        ...
        <div className="homec-search-form__group border-2 rounded-lg ">
