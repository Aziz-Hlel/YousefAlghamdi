...
export const updateAgentSchema = createAgentSchema.innerType().omit({ password: true, confirmPassword: true });
...
export type AgentFormType = createAgentSchemaType & Partial<updateAgentSchemaType>;
